...
int main()
{
    do{
        ...
        switch(pil){
            ...
            default:
                cout << "\nTERIMA KASIH" << endl;
                cout << "Program was made by Helga Lathif Martiza (2410817210025)" << endl;
        }
    ...
    void hapusBelakang(){
        if(isEmpty() == 0){
            ...
            delete hapus;
        } else cout << "Tidak terdaoat adata pada Linked List." << endl;
    }
    ...
    void tampilkan(){
        if(isEmpty() == 0){
            ...
            cout << endl;
        } else cout << "Tidak terdapat data pada Lonked List." << endl;
    }
